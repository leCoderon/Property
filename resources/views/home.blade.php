            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-9 text-center">
                    ...
                    <form action="#" class="narrow-w form-search d-flex align-items-stretch mb-3" data-aos="fade-up"
                        data-aos-delay="200">
                        <input type="text" class="form-control px-4" name="city"
        ...
        <div class="container">
            <div class="row mb-5 align-items-center">
                ...
                <div class="col-lg-6 text-lg-end">
                    <p>
                        <a href="{{ route('property.index') }}" class="btn btn-primary text-white btn-sm">View all
                            {{-- {{route('property.show')}} --}}
                            properties</a>
                    </p>
                </div>
                ...
                <div class="col-12">
                    <div class="property-slider-wrap">
                        <div class="property-slider">
                            ...
                            @empty
                                <div class="alert text-white mt-4 d-block" style="background: #005555">Aucune propriété ne
                                    correspond à votre
                                    recherche</div>
                            @endforelse
